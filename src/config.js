...
export const TURRET_DEFS = {
  ...
  laser: {
    ...
    color: "#67e6ff",
    levels: [
      { cooldown: 2700, damage: 0.12, speed: 0, ammoCost: 1, width: 15 },
      { cooldown: 2300, damage: 0.15, speed: 0, ammoCost: 1, width: 18 },
      { cooldown: 1900, damage: 0.18, speed: 0, ammoCost: 1, width: 21 },
    ],
  },
};
